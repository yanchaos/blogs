...
class Article(models.Model):
    ...
    img = models.ImageField(verbose_name='文章图片', upload_to='article_img/%Y/%m/%d/', blank=True, null=True)
    body = UEditorField(verbose_name='内容',width=800,height=500,toolbars='full', imagePath='upimg/',filePath='upfile', upload_settings={'imageMaxSize': 1024000},
...
class Banner(models.Model):
    ...
    is_active = models.BooleanField('是否为active', default=False)
